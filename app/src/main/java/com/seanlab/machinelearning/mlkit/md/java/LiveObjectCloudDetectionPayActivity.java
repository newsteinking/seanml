...
import com.seanlab.machinelearning.mlkit.md.common.VisionImageProcessor;
import com.seanlab.machinelearning.mlkit.md.java.camera.CameraSource;
import com.seanlab.machinelearning.mlkit.md.java.camera.CameraSourcePreview;
import com.seanlab.machinelearning.mlkit.md.java.camera.GraphicOverlay;
import com.seanlab.machinelearning.mlkit.md.java.camera.WorkflowModel;
import com.seanlab.machinelearning.mlkit.md.java.camera.WorkflowModel.WorkflowState;
import com.seanlab.machinelearning.mlkit.md.java.objectdetection.DetectedObject;
import com.seanlab.machinelearning.mlkit.md.java.objectdetection.MultiObjectProcessor;
import com.seanlab.machinelearning.mlkit.md.java.objectdetection.ProminentObjectProcessor;
import com.seanlab.machinelearning.mlkit.md.java.productsearch.BottomSheetScrimView;
...
public class LiveObjectCloudDetectionPayActivity extends AppCompatActivity implements OnClickListener {

  private static final String TAG = "LiveCloudPayActivity";
  ...
  private void updateTextViews() {
    ...
    Toast.makeText(this, String.format("%s is%s purchased", PRODUCT_ID, bp.isPurchased(PRODUCT_ID) ? "" : " not"), Toast.LENGTH_LONG).show();

    Toast.makeText(this, String.format("%s is%s subscribed", SUBSCRIPTION_ID, bp.isSubscribed(SUBSCRIPTION_ID) ? "" : " not"), Toast.LENGTH_LONG).show();
