...
import com.seanlab.machinelearning.mlkit.ghost.error.UrlNotFoundException;
...
import static com.seanlab.machinelearning.mlkit.ghost.util.NetworkUtils.networkCall;
    ...
    private static Single<Response> checkUrl(@NonNull String url,
        ...
        try {
            Request request = new Request.Builder()
                    ...
                    .build();
            return NetworkUtils.networkCall(client.newCall(request));
