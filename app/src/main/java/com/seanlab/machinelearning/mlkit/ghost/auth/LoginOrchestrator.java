...
import com.seanlab.machinelearning.mlkit.ghost.error.LoginFailedException;
import com.seanlab.machinelearning.mlkit.ghost.event.LoginDoneEvent;
import com.seanlab.machinelearning.mlkit.ghost.event.LoginErrorEvent;
...
import com.seanlab.machinelearning.mlkit.ghost.network.entity.ApiError;
import com.seanlab.machinelearning.mlkit.ghost.network.entity.ApiErrorList;
import com.seanlab.machinelearning.mlkit.ghost.network.entity.AuthReqBody;
import com.seanlab.machinelearning.mlkit.ghost.network.entity.ConfigurationList;
import com.seanlab.machinelearning.mlkit.ghost.util.Listenable;
...
import static com.seanlab.machinelearning.mlkit.ghost.event.BusProvider.getBus;
        ...
        Listenable<LoginOrchestrator.Listener>
{
    ...
    private void handleAuthToken(AuthToken authToken) {
        ...
        BusProvider.getBus().post(new LoginDoneEvent(mValidBlogUrl));
    }
    ...
    private void handleError(Throwable e) {
        ...
        BusProvider.getBus().post(new LoginErrorEvent(blogUrl));
    }
