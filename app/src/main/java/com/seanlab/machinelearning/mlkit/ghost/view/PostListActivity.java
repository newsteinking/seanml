package com.seanlab.machinelearning.mlkit.ghost.view;
...
import com.seanlab.machinelearning.mlkit.ghost.error.SyncException;
...
import com.seanlab.machinelearning.mlkit.ghost.util.DeviceUtils;
...
import com.seanlab.machinelearning.mlkit.ghost.view.image.BorderedCircleTransformation;
import com.seanlab.machinelearning.mlkit.ghost.view.widget.SpaceItemDecoration;
...
import com.seanlab.machinelearning.mlkit.ghost.SpectreApplication;
import com.seanlab.machinelearning.mlkit.ghost.account.AccountManager;
import com.seanlab.machinelearning.mlkit.ghost.error.SyncException;
import com.seanlab.machinelearning.mlkit.ghost.event.BlogSettingsLoadedEvent;
import com.seanlab.machinelearning.mlkit.ghost.event.CreatePostEvent;
...
import static com.seanlab.machinelearning.mlkit.ghost.util.NetworkUtils.isConnectionError;
import static com.seanlab.machinelearning.mlkit.ghost.util.NetworkUtils.makePicassoUrl;
...
public class PostListActivity extends BaseActivity {
    ...
    public void onUserLoadedEvent(UserLoadedEvent event) {
        if (event.user.getProfileImage() != null) {
            ...
            String imageUrl = NetworkUtils.makePicassoUrl(blogUrl, event.user.getProfileImage());
            getPicasso()
                    .load(imageUrl)
